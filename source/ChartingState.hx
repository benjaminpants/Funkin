...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var player3DropDown = new FlxUIDropDownMenu(10, 160, FlxUIDropDownMenu.makeStrIdLabelArray(characters, true), function(character:String)
		{
			_song.girlfriend = characters[Std.parseInt(character)];
		});

		player3DropDown.selectedLabel = _song.girlfriend;
	...
	function updateGrid():Void
	{
		...
		for (i in sectionInfo)
		{
			...
			var daStrumTime = i[0];
			var daSus = i[2];
			var daType = i[3] == null ? "n" : i[3];
			var note:Note = new Note(daStrumTime, daNoteInfo % KeyAmount,null,false,daType,false,noteTypesMap[daType]);
